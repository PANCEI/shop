...
<body>
    ...
    <div class="login-div">
        ...
        <div class="sub-tittle">Reset Password</div>
        <div class="form-container">
            <form method="POST" autocomplete="off">
                <div class="username">
                    <i class="fas fa-key"></i>
                    <input type="password" class="user-input" placeholder="Masukan Password" name="pass" id="name" autocomplete="off" required value="<?php echo set_value('password'); ?>">
                </div>
