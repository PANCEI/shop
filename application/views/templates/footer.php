...
<footer class="main-footer">
    <strong>Copyright &copy; <?= date("Y")  ?> Pance Shop .</strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
        <img src="<?= base_url("asset/dist/img/logo.png") ?>" alt="">
    </div>
</footer>
...
<!-- JQVMap -->
<script src="<?= base_url('asset/') ?>plugins/jqvmap/jquery.vmap.js"></script>
<script src="<?= base_url('asset/') ?>plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
<script src="<?= base_url('asset/') ?>plugins/jqvmap/maps/jquery.vmap.indonesia.js"></script>
<script src="<?= base_url('asset/') ?>plugins/jqvmap/maps/indonesia-adm2-27.js"></script>
<!-- jQuery Knob Chart -->
...
<script src="<?= base_url("asset/js/event.js") ?>"></script>
<script>
